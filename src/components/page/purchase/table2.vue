        ...
        <div class="purchase-table-title">
             ...
             <div class="purchase-table-desc">
                <ul>
                    <li class="purchase-desc-item">
                        订单号：<input type="text" :value="t_data.store_number" readonly>
                    </li>
                    <li class="purchase-desc-item">
                        订单名称：<input type="text" :value="t_data.store_name" readonly>
                    </li>
                </ul>
            </div>
            <div class="table-list">
                <table border="1" id="table" ref="table">
                    ...
                    <tr class="table-item" v-for="(item,index) in t_data.rows" :key="index">
                        <td>
                        ...
                        <td>
                            <input type="text" v-model="item.cg_number" readonly>
                        </td>
                        <td>
                            <input type="text" v-model="item.cg_price" readonly>
                        </td>
                        <td>
                            <input type="text" :value="parseInt(item.cg_number)*parseFloat(item.cg_price)" readonly>
                        </td>
                        <td>
                            <input type="text" v-model="item.depot" readonly>
                        </td>
                        <td>
